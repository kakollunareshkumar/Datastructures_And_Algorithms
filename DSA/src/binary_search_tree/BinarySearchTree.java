   ...
   */
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        boolean value  =  bst.search(16);
        System.out.println("Element present in Binary Search Tree "+value);

        Node element  = bst.search(54, bst.root);
        if(element==null)
        {
        ...
        {
            System.out.println("Element is present in binary search tree "+element.data);
        }

        boolean edeleted = bst.delete(16);
        System.out.println("Element is deleted "+edeleted);

        Node delNode = bst.delete(bst.root, 54);
        if(delNode==null)
        {
            System.out.println("Element is not present in binary search tree");
        }
        ...
        {
            System.out.println("Element is deleted from binary search tree ");
        }

        //inorder traversal
        System.out.println("In order traversal elements");
        bst.inOrderTraversal(); //output [3,9,10,15,16,52,54,56,61]

        //pre-order
        System.out.println();
        System.out.println("pre order traversal elements");
        bst.preOrderTraversal(); //output [52,15,9,3,10,16,56,54,61]

        //post-order
        System.out.println();
        System.out.println("post order traversal elements");
...
https://github.com/javadevjournal/javadevjournal/blob/master/Java/data-structure-with-java/src/main/java/com/javadevjournal/datastructure/tree/bst/BinarySearchTree.java
