...
public class CircularLinkedList {
    ...
    public void deleteLast() {
        System.out.println("Delete Node at last position");
        if (head == null) {
            return;
        } else {
            if (head != tail) {
...
/*
References:
https://www.javadevjournal.com/data-structure/circular-singly-linked-list/
*/

 /*
Time Complexity:
https://www.programiz.com/dsa/circular-linked-list
Best case:O(1) when element inserted at first or last position O(n) when insertion occurs at a specific position
Worst case:O(1) and O(n)
Average case:O(1) and O(n)
